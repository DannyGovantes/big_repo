...
},{}],"file.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.uploadHomework = void 0;
...
var uploadHomework = /*#__PURE__*/function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Se entregó tu tarea');
  ...
  return function uploadHomework(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.uploadHomework = uploadHomework;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"group.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.shareGroup = exports.requestAccessF = exports.createGroup = exports.acceptUsers = void 0;
...
var createGroup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, school, sequence, description) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Grupo creado');
              window.setTimeout(function () {
  ...
  return function createGroup(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var shareGroup = function shareGroup(shareLink, tooltip) {
...
var acceptUsers = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(student, slug) {
    var res;
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'succcess') {
              (0, _alerts.showAlert)('success', 'Alumno aceptado');
              window.setTimeout(function () {
                location.reload();
              }, 500);
            }
  ...
  return function acceptUsers(_x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();

exports.acceptUsers = acceptUsers;

var requestAccessF = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'succcess') {
              (0, _alerts.showAlert)('success', 'Solicitud Enviada');
              window.setTimeout(function () {
                location.assign('/');
              }, 500);
            }
  ...
  return function requestAccessF(_x7) {
    return _ref3.apply(this, arguments);
  };
}();

exports.requestAccessF = requestAccessF;
},{"axios":"../../node_modules/axios/index.js","regenerator-runtime":"../../node_modules/regenerator-runtime/runtime.js","./alerts":"alerts.js"}],"homework.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateHomework = exports.createHomework = void 0;
...
var createHomework = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, description, timeLimit, group) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Tarea creada');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function createHomework(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var updateHomework = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(description, timeLimit) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function updateHomework(_x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Bienvenido');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:4000/api/v1/users/updatePassword' : 'http://localhost:4000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', '¡Enhorabuena! tus datos se actualizaron correctamente');
            }
...
var homeworkForm = document.querySelector('.form--homework');
var groupForm = document.querySelector('.form--group');
var shareButtons = document.querySelectorAll('.share-button');
var acceptButtons = document.querySelectorAll('.request-button');
var uploadFileForm = document.querySelector('.form--file');
...
if (homeworkForm) {
  homeworkForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var name, description, timeLimit, group;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              (0, _homework.createHomework)(name, description, timeLimit, group);
...
if (groupForm) {
  groupForm.addEventListener('submit', function (e) {
    ...
    (0, _group.createGroup)(name, school, sequence, description);
  });
}
...
if (shareButtons) {
  shareButtons.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      (0, _group.shareGroup)(btn, tooltip);
    });
  });
}
...
if (acceptButtons) {
  acceptButtons.forEach(function (btn) {
    btn.addEventListener('click', function () {
      var data = document.getElementById('requestButton').value;
      var student = data.split(' ')[0];
      var slug = data.split(' ')[1];
      (0, _group.acceptUsers)(student, slug);
    });
  });
}
...
if (uploadFileForm) {
  uploadFileForm.addEventListener('submit', function (e) {
    ...
    (0, _file.uploadHomework)(form);
  });
}

if (requestAccess) {
  requestAccess.addEventListener('click', function () {
    var slug = document.getElementById('request').value;
    (0, _group.requestAccessF)(slug);
  });
}
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./file":"file.js","./group":"group.js","./homework":"homework.js","./login":"login.js","./signup":"signup.js","./updateSettings":"updateSettings.js"}]},{},["index.js"], null)
